    ...
    LoanServicePort: {
      ...
      RegistrarPrestamo: async (args) => {
        try {
            ...
            const { usuarioId, libroId, fechaPrestamo, fechaDevolucion, bibliotecaId } = args;
            ...
            const registrarPrestamoQuery = `
                INSERT INTO prestamos (usuario_id, libro_id, fecha_prestamo, fecha_devolucion, estado, biblioteca_id)
                VALUES ($1, $2, $3, $4, $5, $6)
                RETURNING prestamo_id
            `;
            const registrarPrestamoResult = await db.query(registrarPrestamoQuery, [
                usuarioId, libroId, fechaPrestamo, fechaDevolucion, 'activo', bibliotecaId
            ]);
